 ...
 * -使用arm_neon
 * -设置cpu亲和性
 * -赛后增加-来自网上分享-特征值可以直接为char的ASCII，不用减'0'!!!
 */
...
//    char *fcs=new char[5];//0.xxx
    ...
    while(jd<size){
        tempf[0]=testData[jd+2];
        tempf[1]=testData[jd+8];
        tempf[2]=testData[jd+14];
        tempf[3]=testData[jd+20];
...
//        f4t_fts1=vld1q_f32(tfs+recNum+jnow);
        ...
        tempf[0]=testData[jd+26];
        tempf[1]=testData[jd+32];
        tempf[2]=testData[jd+38];
        tempf[3]=testData[jd+44];
...
//        f4t_fts1=vld1q_f32(tfs+recNum+jnow+4);
        ...
        tempf[0]=testData[jd+50];
        tempf[1]=testData[jd+56];
        tempf[2]=testData[jd+62];
        tempf[3]=testData[jd+68];
...
//        f4t_fts1=vld1q_f32(tfs+recNum+jnow+8);
        ...
        tempf[0]=testData[jd+74];
        tempf[1]=testData[jd+80];
        tempf[2]=testData[jd+86];
        tempf[3]=testData[jd+92];
...
//        f4t_fts1=vld1q_f32(tfs+recNum+jnow+12);
        ...
        tempf[0]=testData[jd+98];
        tempf[1]=testData[jd+104];
        tempf[2]=testData[jd+110];
        tempf[3]=testData[jd+116];
